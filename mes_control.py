...
# 1. set parameters
Pi_IP_address = '192.168.137.62' # USER INPUT get IP address from mobile hotspot settings
...
repeats = 2 # USER INPUT number of IV curves measured per device
...
deviceList = [35,39,41,45,21,19,15,13,36] # USER INPUT enter all devices you want to measure
